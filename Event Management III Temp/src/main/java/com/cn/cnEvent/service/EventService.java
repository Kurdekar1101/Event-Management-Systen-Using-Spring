...
public class EventService {
	...
	public EventScheduleDetail getEventScheduleDetailByEventId(Long id) {
		...
		if(event.getEventScheduleDetail() == null) {
			throw new NotFoundException("No Event Schedule Detail found for eventId: " + id);
		}
		return event.getEventScheduleDetail();
	}

	@Transactional
	public String deleteEventScheduleDetailByEventId(Long id) {
		//Event event = getEventById(id);
//	    if (event.getEventScheduleDetail() == null) {
//	        throw new InvalidInputException("No EventScheduleDetail found to delete for eventId: " + id);
//	    }
	    try {
...
//	    eventDAL.save(event);
	    //return eventDAL.deleteEventScheduleDetailByEventId(id);
	    //return "The eventSchedule was deleted successfully";
	}

	@Transactional
	public List<Event> getEventsByLocation(String location) {
		return eventDAL.getEventsByLocation(location);
	}

	@Transactional
	public List<Ticket> getAllTicket(Long id) {
		// TODO Auto-generated method stub
		return eventDAL.getAllTicket(id);
	}

	@Transactional
	public List<Event> getGreaterPrice(Long price) {
		// TODO Auto-generated method stub
		return eventDAL.getGreaterPrice(price);
	}
}
